...
public final class VSpanUtil {
     ...
     *             </ul>
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setForegroundColor(@ColorInt final int color) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setBackgroundColor(@ColorInt final int color) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setLineHeight(@IntRange(from = 0) final int lineHeight, @Align final int align) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setQuoteColor(@ColorInt final int color) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setQuoteColor(@ColorInt final int color, @IntRange(from = 1) final int stripeWidth, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setLeadingMargin(@IntRange(from = 0) final int first, @IntRange(from = 0) final int rest) {
        this.first = first;
        this.rest = rest;
        return this;
    }
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setBullet(@ColorInt final int color, @IntRange(from = 0) final int radius, @IntRange(from = 0) final int gapWidth) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(final Bitmap bitmap) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(final Bitmap bitmap, final int gapWidth, @Align final int align) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(final Drawable drawable) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(final Drawable drawable, final int gapWidth, @Align final int align) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(final Uri uri) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(final Uri uri, final int gapWidth, @Align final int align) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(@DrawableRes final int resourceId) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setIconMargin(@DrawableRes final int resourceId, final int gapWidth, @Align final int align) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setFontSize(@IntRange(from = 0) final int size, final boolean isDp) {
        this.fontSize = size;
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setFontProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setFontXProportion(@FloatRange(from = 0, fromInclusive = false) final float proportion) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setStrikethrough() {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setSuperscript() {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setAlign(@NonNull final Alignment alignment) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius, final Blur style) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
							   final float dx,
							   final float dy,
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil append(@NonNull final CharSequence text) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@NonNull final Drawable drawable) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@NonNull final Uri uri) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@DrawableRes final int resourceId) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return {@link VSpanUtil}
     */
    public VSpanUtil appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
    ...
    class CustomIconMarginSpan implements LeadingMarginSpan, android.text.style.LineHeightSpan {
        ...
        private Bitmap uri2Bitmap(final Uri uri) {
            try {
                return MediaStore.Images.Media.getBitmap(VFrame.getApplication().getContentResolver(), uri);
            } catch (IOException e) {
                e.printStackTrace();
        ...
        private Bitmap resource2Bitmap(final int resourceId) {
            Drawable drawable = ContextCompat.getDrawable(VFrame.getApplication(), resourceId);
    ...
    class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(VFrame.getApplication().getResources(), b);
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                Bitmap bitmap;
                try {
                    InputStream is = VFrame.getApplication().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(VFrame.getApplication().getResources(), bitmap);
                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                    if (is != null) {
                        is.close();
                    }
                ...
                try {
                    drawable = ContextCompat.getDrawable(VFrame.getApplication(), mResourceId);
                    drawable.setBounds(0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight());
                } catch (Exception e) {
