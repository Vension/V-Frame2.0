 ...
 * 日  期：2018/4/2 11:22
 * 描  述：根据用户点击状态设置不同的图片
          app:normalBackground="" //设置ImageView的背景
          app:pressedBackground=""
          app:unableBackground=""
          app:animDuration="200" //设置背景切换动画时长
 * ========================================================
 */

public class VStateImageView extends AppCompatImageView {
    ...
    public VStateImageView(Context context) {
        this(context, null);
    }

    public VStateImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VStateImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.VStateImageView);

        mNormalDrawable = a.getDrawable(R.styleable.VStateImageView_normalBackground);
        mPressedDrawable = a.getDrawable(R.styleable.VStateImageView_pressedBackground);
        mUnableDrawable = a.getDrawable(R.styleable.VStateImageView_unableBackground);
        setStateBackground(mNormalDrawable, mPressedDrawable, mUnableDrawable);

        mDuration = a.getInteger(R.styleable.VStateImageView_si_animDuration, mDuration);
