...
public final class VCleanUtil {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(VFrame.getApplication().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(VFrame.getApplication().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(VFrame.getApplication().getFilesDir().getParent() + File.separator + "databases");
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return VFrame.getApplication().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSP() {
        return deleteFilesInDir(VFrame.getApplication().getFilesDir().getParent() + File.separator + "shared_prefs");
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState()) && deleteFilesInDir(VFrame.getApplication().getExternalCacheDir());
    }
