...
import com.vension.frame.utils.constants.MemoryConstants;
...
import static com.vension.frame.utils.constants.MemoryConstants.BYTE;
import static com.vension.frame.utils.constants.MemoryConstants.GB;
import static com.vension.frame.utils.constants.MemoryConstants.KB;
import static com.vension.frame.utils.constants.MemoryConstants.MB;

/**
 * Created by Vension on 2017/10/24.
 * 数据处理相关
 * <p>
 * ┌───┐   ┌───┬───┬───┬───┐ ┌───┬───┬───┬───┐ ┌───┬───┬───┬───┐ ┌───┬───┬───┐
...
public class DataUtil {
     ...
     * @param byteNum 字节数
     * @param unit    <ul>
     *                <li>{@link MemoryConstants.MemoryUnit#BYTE}: 字节</li>
     *                <li>{@link MemoryConstants.MemoryUnit#KB}  : 千字节</li>
     *                <li>{@link MemoryConstants.MemoryUnit#MB}  : 兆</li>
     *                <li>{@link MemoryConstants.MemoryUnit#GB}  : GB</li>
     *                </ul>
     * @return 以unit为单位的size
     */
    public static double byte2Size(long byteNum, MemoryConstants.MemoryUnit unit) {
     ...
     * @return 字节数
     */
    public static long size2Byte(long size, MemoryConstants.MemoryUnit unit) {
        if (size < 0) return -1;
        switch (unit) {
            default:
            case BYTE:
