package com.vension.frame.utils.pageTransformer;
...
public class VerticalStackPageTransformerWithRotation implements ViewPager.PageTransformer {
    ...
    public void transformPage(@NonNull View view, float position) {
        ...
        float verticalOffsetBase = (pagerHeight - pagerHeight * CENTER_PAGE_SCALE) / 2 / offscreenPageLimit + VSizeUtil.dip2px(15);
