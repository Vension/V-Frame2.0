...
public final class ActivityUtil {
    ...
    public static boolean isActivityExists(@NonNull final String packageName,
        ...
        return !(VFrame.getApplication().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(VFrame.getApplication().getPackageManager()) == null ||
                VFrame.getApplication().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(VFrame.getApplication().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        if (VFrame.getActivityListStackTop() != null) {
            Activity activity = VFrame.getActivityListStackTop();
            if (activity != null) {
                return activity;
            }
        }
        List<Activity> activities = VFrame.getActivityList();
    ...
    public static void finishAllActivities(final boolean isLoadAnim) {
        List<Activity> activityList = VFrame.getActivityList();
    ...
    private static Context getActivityOrApp() {
        ...
        return topActivity == null ? VFrame.getApplication() : topActivity;
    }
