 ...
 * 作  者：Vension
 * 日  期：2018/4/2 11:24
 * 描  述：可设置形状的ImageView，抗边缘锯齿
 * ========================================================
 */

public class VShapeImageView extends AppCompatImageView {
    ...
    public VShapeImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VShapeImageView(Context context, AttributeSet attrs, int defStyle) {
