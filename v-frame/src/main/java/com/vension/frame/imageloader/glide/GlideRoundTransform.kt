...
/**
 * Created by Vension on 2017/11/29.
 * desc:
...
class GlideRoundTransform @JvmOverloads constructor(context: Context = VFrame.getContext(), dp: Int = 4) : BitmapTransformation(context) {
