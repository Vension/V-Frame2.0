package com.vension.frame.utils.handler;
...
public class VHandler {
     ...
     */
    public VHandler(@Nullable Handler.Callback callback) {
     ...
     */
    public VHandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    public VHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
