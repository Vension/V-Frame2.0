...
public class MultipleStatusView extends RelativeLayout {
    ...
    public static final int STATUS_CONTENT    = 0x00;  //显示内容
    public static final int STATUS_LOADING    = 0x01;  //加载中...
    public static final int STATUS_EMPTY      = 0x02;  //空数据状态
    public static final int STATUS_ERROR      = 0x03;  //加载出错状态
    public static final int STATUS_NO_NETWORK = 0x04;  //网络连接问题

    private static final int NULL_RESOURCE_ID = -1;    //默认内容id
    ...
    public MultipleStatusView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mEmptyViewResId = a.getResourceId(R.styleable.MultipleStatusView_emptyView, R.layout.v_layout_empty_view);
        mErrorViewResId = a.getResourceId(R.styleable.MultipleStatusView_errorView, R.layout.v_layout_error_view);
        mLoadingViewResId = a.getResourceId(R.styleable.MultipleStatusView_loadingView, R.layout.v_layout_loading_view);
        mNoNetworkViewResId = a.getResourceId(R.styleable.MultipleStatusView_noNetworkView, R.layout.v_layout_network_view);
