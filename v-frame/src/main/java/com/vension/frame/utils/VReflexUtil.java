 ...
 *     @desc  : 反射相关工具类
 */
public class VReflexUtil {

	private final Class<?> type;

	private final Object object;

	private VReflexUtil(Class<?> type) {
		this(type, type);
	}

	private VReflexUtil(Class<?> type, Object object) {
		this.type = type;
		this.object = object;
	}

	public static VReflexUtil init(@NonNull final String name) {
		return init(forName(name));
	}

	public static VReflexUtil init(@NonNull final String name, @NonNull final ClassLoader classLoader) {
		return init(forName(name, classLoader));
	}

	public static VReflexUtil init(@NonNull final Class<?> clazz) {
		return new VReflexUtil(clazz);
	}

	public static VReflexUtil init(@NonNull final Object object) {
		return new VReflexUtil(object.getClass(), object);
	}

	private static VReflexUtil init(Class<?> type, Object object) {
		return new VReflexUtil(type, object);
	}
	...
	public VReflexUtil set(String name, Object value) {
		try {
	...
	public VReflexUtil field(String name) {
		try {
			Field field = field0(name);
	 ...
	 */
	public Map<String, VReflexUtil> fields() {
		Map<String, VReflexUtil> result = new LinkedHashMap<String, VReflexUtil>();
		Class<?> t = type();
	 ...
	 */
	public VReflexUtil call(String name) {
	 ...
	 * @throws RuntimeException If any reflection exception occurred.
	 */
	public VReflexUtil call(String name, Object... args) {
	 ...
	 * @throws RuntimeException If any reflection exception occurred.
	 */
	public VReflexUtil create(Object... args) {
		Class<?>[] types = types(args);
	...
	public boolean equals(Object obj) {
		if (obj instanceof VReflexUtil) {
			return object.equals(((VReflexUtil) obj).get());
		}
	 ...
	 */
	private static VReflexUtil init(Constructor<?> constructor, Object... args) {
		try {
	 ...
	 */
	private static VReflexUtil init(Method method, Object object, Object... args) {
		try {
			accessible(method);
	...
	private static Object unwrap(Object object) {
		if (object instanceof VReflexUtil) {
			return ((VReflexUtil) object).get();
		}
