...
public class VSizeUtil {
	...
	public static int dip2px(float dpValue) {
		final float scale = VFrame.getDisplayMetrics().density;
	...
	public static int sp2px(float spValue) {
		final float fontScale = VFrame.getDisplayMetrics().scaledDensity;
	...
	public static int getScreenWidth() {
		return VFrame.getDisplayMetrics().widthPixels;
	}
	...
	public static int getScreenHeight() {
		return VFrame.getDisplayMetrics().heightPixels;
	}
	...
	public static int getScreenRealHeight() {
		int h;
		WindowManager winMgr = (WindowManager) VFrame.getSystemService(Context.WINDOW_SERVICE);
	...
	public static int getStatusBarHeight() {
		...
		try {
			...
			statusBarHeight = VFrame.getResources().getDimensionPixelSize(x);
		} catch (Exception e1) {
			e1.printStackTrace();
		}
	...
	public static int getNavigationBarHeight() {
		...
		Resources resources = VFrame.getResources();
